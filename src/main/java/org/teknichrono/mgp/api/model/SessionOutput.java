...
public class SessionOutput {
  ...
  public static final String TOPSPEED_OPTION = "topspeed";
  ...
  public SessionOutput(boolean withAdditionalOptions) {
    if (withAdditionalOptions) {
      ...
      additionalOptions.add(Choice.from(TOPSPEED_OPTION, TOPSPEED_DESCRIPTION));
      additionalOptions.add(Choice.from(ANALYSIS_OPTION, ANALYSIS_DESCRIPTION));
    }
  }
